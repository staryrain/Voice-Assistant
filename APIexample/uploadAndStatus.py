...
def train(appid, token, audio_path, spk_id):
    ...
    data = {"appid": appid, "speaker_id": spk_id, "audios": audios, "source": 2,"language": 0, "model_type": 4}
    # 额外参数
    extra_params = {}
    if extra_params:
...
if __name__ == "__main__":
    appid = "2078616776"
    token = "7KpKwBDOlRBlEXB6sbcIyhJa-01pUa-U"
    spk_id = "S_X19Lm8ON1"
    train(appid=appid, token=token, audio_path=r"F:\So-Vits-SVC\dataset_raw\raw_Fulina\vo_furina_friendship_03.wav", spk_id=spk_id)
