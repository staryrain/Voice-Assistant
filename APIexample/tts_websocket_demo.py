...
appid = "1972357714"
token = "jhG-6VnZk0h4EAhD9CekJRo8OpVSLFkd"
cluster = "volcano_icl"
voice_type = "S_FwdJnJNN1"
...
async def test_wakeresponse():
    ...
    file_to_save = open("test_wakeresponse.mp3", "wb")
...
if __name__ == '__main__':
    ...
    loop.run_until_complete(test_wakeresponse())
